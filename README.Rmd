...
The goal of vecsymr is to implement Vector Symbolic Architecture (VSA) primitives to 
...
You can install the development version of vecsymr from [GitHub](https://github.com/) with:
